...
const Graph = ForceGraph3D()(document.getElementById("mindmap"))
  ...
  { id: "deca", group: 2, fx: 125, fy: 50, fz: 0, img: 'assets/deca.png' },
  { id: "fblc", group: 2, fx: -50, fy: 50, fz: 50, img: 'assets/fblc.jpeg' },
  { id: "tu20", group: 2, fx: 0, fy: 50, fz: 0, img: 'assets/tu20.jpg' },
  { id: "cssc", group: 2, fx: 100, fy: 50, fz: 0, img: 'assets/cssc.png' },
  { id: "python", group: 2, fx: -50, fy: 100, fz: 0, img: 'assets/python.png' },
  { id: "java", group: 2, fx: 0, fy: 125, fz: 50, img: 'assets/java.png' },
  { id: "html", group: 2, fx: 75, fy: 10, fz: 75, img: 'assets/html.png' },
  { id: "css", group: 2, fx: 100, fy: 60, fz: 10, img: 'assets/css.png' },
  { id: "js", group: 2, fx: 50, fy: 0, fz: 100, img: 'assets/js.png' },
    ],
    links: [
